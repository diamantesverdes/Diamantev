                  ...
                  <>
                    ...
                    <div className="admin-list">
                      ...
                      {lotes.map(lote => {
                        ...
                        return (
                          <div key={lote.id} className="admin-item lote-group" style={{ width: '100%', maxWidth: '100%', overflow: 'hidden', boxSizing: 'border-box' }}>
                            <div className="admin-item-info">
                              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                              ...
                              <div style={{ width: '100%', maxWidth: '100%', overflowX: 'auto', WebkitOverflowScrolling: 'touch', touchAction: 'pan-x pan-y', marginTop: 2, borderRadius: 8, border: '1px solid #ddd', boxShadow: '0 1px 2px rgba(0,0,0,0.06)', boxSizing: 'border-box' }}>
                                <table className="invoice-table" style={{ borderCollapse: 'collapse', width: '100%', minWidth: 420, fontSize: 11 }}>
                                  <thead>
                                    <tr style={{ background: '#f3ecdd' }}>
