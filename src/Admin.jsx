                ...
                return (
                  <>
                    <div style={{ display: 'flex', gap: 8, marginBottom: 10, flexWrap: 'wrap' }}>
                      {!loteBuilderOpen && (
                        <button type="button" className="full-form-btn" onClick={() => { setLoteBuilderOpen(true); setLoteStep('header'); setLoteAddMode('choose') }}>🧺 Nueva compra</button>
                      )}
                    ...
                    {loteBuilderOpen && loteStep === 'products' && (
                      <div className="admin-form">
                        ...
                        {/* Título + botones de acción: primero lo que el usuario necesita presionar, sin scroll */}
                        ...
                        {/* Estado vacío: aviso sutil debajo de los botones, ya no bloquea la vista */}
                        {loteLines.length === 0 && (
                          <p className="status-msg" style={{ margin: '0 0 14px', fontSize: '0.8rem', opacity: 0.7 }}>Aún no has agregado productos.</p>
                        )}

                        {/* Resumen en tabla: solo ocupa espacio cuando ya hay productos */}
                        {loteLines.length > 0 && (
                        ...
                        {/* Agregar planta: heading + subvistas de búsqueda/registro, solo una vez elegido el camino */}
                        {loteAddMode !== 'choose' && <h4>Agregar planta a esta compra</h4>}
                        ...
                        {loteAddMode === 'search' && !lineForm.plant_id && (
                          <div>
                            <button
                              ...
                              style={{ fontSize: '0.8rem', background: 'none', border: 'none', color: '#4a5d3a', textDecoration: 'underline', cursor: 'pointer', padding: '4px 0', marginBottom: 6 }}
                            >
                              ← Elegir otra opción
                            </button>
                            <select
                        ...
                        {loteAddMode === 'new' && (
                          <div style={{ background: '#f3ecdd', padding: 12, borderRadius: 8, marginTop: 4, border: '1px solid #d8cdb0' }}>
                            ...
                            <input placeholder="Nombre de la planta" value={lineForm.new_plant_name} onChange={e => setLineForm({ ...lineForm, plant_id: '', new_plant_name: e.target.value })} />
