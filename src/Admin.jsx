                            ...
                            <div style={{ overflowX: 'auto', marginTop: 8 }}>
                              <table style={{ borderCollapse: 'collapse', width: '100%', fontSize: 13 }}>
                                  ...
                                  {lineasConProrrateo.map(d => (
                                    <tr key={d.id}>
                                      <td style={{ padding: 4, border: '1px solid #ddd' }}>
                                        <input defaultValue={d.plant_name} onBlur={e => updateDecrementoField(d, 'plant_name', e.target.value)} style={{ width: 90 }} />
                                      </td>
                                      <td style={{ padding: 4, border: '1px solid #ddd' }}>
                                      ...
                                      <td style={{ padding: 4, border: '1px solid #ddd', textAlign: 'center' }}>
                                        <input type="number" defaultValue={d.quantity} onBlur={e => updateDecrementoField(d, 'quantity', e.target.value)} style={{ width: 45 }} />
                                      </td>
                                      <td style={{ padding: 4, border: '1px solid #ddd', textAlign: 'right' }}>
                                        <input type="number" step="0.01" defaultValue={d.unit_price || 0} onBlur={e => updateDecrementoField(d, 'unit_price', e.target.value)} style={{ width: 60 }} />
                                      </td>
                                ...
                                <tfoot>
                                  ...
                                  <tr><td colSpan={5} style={{ padding: 4, border: '1px solid #ddd' }}>Envío 1</td><td colSpan={3} style={{ padding: 4, border: '1px solid #ddd', textAlign: 'right' }}><input type="number" step="0.01" defaultValue={lote.envio1 || 0} onBlur={e => updateVentaLoteExtra(lote, 'envio1', e.target.value)} style={{ width: 80 }} /></td></tr>
                                  <tr><td colSpan={5} style={{ padding: 4, border: '1px solid #ddd' }}>Envío 2</td><td colSpan={3} style={{ padding: 4, border: '1px solid #ddd', textAlign: 'right' }}><input type="number" step="0.01" defaultValue={lote.envio2 || 0} onBlur={e => updateVentaLoteExtra(lote, 'envio2', e.target.value)} style={{ width: 80 }} /></td></tr>
                                  <tr><td colSpan={5} style={{ padding: 4, border: '1px solid #ddd' }}>Varios</td><td colSpan={3} style={{ padding: 4, border: '1px solid #ddd', textAlign: 'right' }}><input type="number" step="0.01" defaultValue={lote.varios || 0} onBlur={e => updateVentaLoteExtra(lote, 'varios', e.target.value)} style={{ width: 80 }} /></td></tr>
