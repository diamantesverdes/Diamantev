                        ...
                        <div key={`vl-${lote.id}`} className="admin-item lote-group" style={{ width: '100%', maxWidth: '100%', minWidth: 0, overflow: 'hidden', boxSizing: 'border-box' }}>
                          <div className="admin-item-info" style={{ width: '100%', maxWidth: '100%', minWidth: 0, boxSizing: 'border-box' }}>
                            ...
                            <div style={{ display: 'flex', gap: 8, flexWrap: 'wrap', marginTop: 8 }}>
                              <button
                                type="button"
                                onClick={() => sendVentaInvoiceWhatsApp(lote, lineasConProrrateo, subtotal, totalLote)}
                                style={{ background: '#25D366', color: '#fff', border: 'none', padding: '10px 14px', borderRadius: 6, fontSize: '0.85rem', fontWeight: 600, flex: '1 1 auto' }}
                              >
                                💬 Enviar por WhatsApp
                              </button>
                              <button
                                type="button"
                                onClick={() => downloadVentaInvoicePDF(lote, lineasConProrrateo, subtotal, totalLote)}
                                style={{ background: '#fff', color: '#4a5d3a', border: '1px solid #4a5d3a', padding: '10px 14px', borderRadius: 6, fontSize: '0.85rem', fontWeight: 600, flex: '1 1 auto' }}
                              >
                                ⬇️ Descargar Factura
                              </button>
                            </div>
