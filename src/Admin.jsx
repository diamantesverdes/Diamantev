                  ...
                  <>
                    <div style={{ display: 'flex', gap: 8, marginBottom: 10, flexWrap: 'wrap' }}>
                      {!loteBuilderOpen && (
                        <button
                          ...
                          style={{ background: '#4a5d3a', color: '#fff', border: 'none', padding: '12px 18px', borderRadius: 8, fontSize: '1rem', fontWeight: 700, boxShadow: '0 2px 4px rgba(0,0,0,0.15)' }}
                        >
                          🧺 Nueva compra
                        </button>
                      )}
                      <button
                        ...
                        style={{ background: '#fff', color: '#4a5d3a', border: '1px solid #4a5d3a', padding: '12px 18px', borderRadius: 8, fontSize: '0.95rem', fontWeight: 600 }}
                      >
                        🔍 Buscar compra
                      </button>
                    </div>
                    ...
                    {loteBuilderOpen && loteStep === 'header' && (
                      <div className="admin-form" style={{ display: 'flex', flexDirection: 'column', gap: 10, padding: 14 }}>
                        ...
                        <input
                          placeholder="Nota (ej: 'Iris julio')"
                          value={loteNota}
                          onChange={e => setLoteNota(e.target.value)}
                          style={{ width: '100%', boxSizing: 'border-box', padding: '12px 10px', fontSize: '1rem', borderRadius: 6, border: '1px solid #ccc' }}
                        />
                    ...
                    {loteBuilderOpen && loteStep === 'products' && (
                      <div className="admin-form" style={{ padding: 14 }}>
                        ...
                        <h4 style={{ margin: '0 0 10px' }}>Productos agregados ({loteLines.length})</h4>
                        ...
                        {/* Estado vacío: solo se muestra antes de que el usuario elija un camino; desaparece al interactuar */}
                        {loteLines.length === 0 && loteAddMode === 'choose' && (
                        ...
                        {loteAddMode === 'search' && !lineForm.plant_id && (
                          <div style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
                            <button
                              ...
                              style={{ fontSize: '0.8rem', background: 'none', border: 'none', color: '#4a5d3a', textDecoration: 'underline', cursor: 'pointer', padding: '4px 0', marginBottom: 2, alignSelf: 'flex-start' }}
                            >
                              ← Elegir otra opción
                            </button>
                            <select
