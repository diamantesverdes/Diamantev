                        ...
                        return (
                          <div key={lote.id} className="admin-item lote-group">
                            <div className="admin-item-info">
                              ...
                              <div style={{ width: '100%', overflowX: 'auto', WebkitOverflowScrolling: 'touch', marginTop: 8, borderRadius: 6, border: '1px solid #ddd' }}>
                                <table className="invoice-table" style={{ borderCollapse: 'collapse', width: '100%', minWidth: 480, fontSize: 11 }}>
                                  <thead>
                                    <tr style={{ background: '#f3ecdd' }}>
                                      <th style={{ padding: '3px 2px', border: '1px solid #ddd' }}>Foto</th>
                                      <th style={{ padding: '3px 2px', border: '1px solid #ddd' }}>Nombre</th>
                                      <th style={{ padding: '3px 2px', border: '1px solid #ddd' }}>Cant</th>
                                      <th style={{ padding: '3px 2px', border: '1px solid #ddd' }}>P.Unit</th>
                                      <th style={{ padding: '3px 2px', border: '1px solid #ddd' }}>P.Tot</th>
                                      <th style={{ padding: '3px 2px', border: '1px solid #ddd' }}>Pror.</th>
                                      <th style={{ padding: '3px 2px', border: '1px solid #ddd' }}>Total</th>
                                      <th style={{ padding: '3px 2px', border: '1px solid #ddd' }}>Estado</th>
                                    </tr>
                                  </thead>
                                  <tbody>
                                    {lineasConProrrateo.map(c => (
                                      <tr key={c.id}>
                                        ...
                                        <td style={{ padding: 2, border: '1px solid #ddd' }}>
                                        ...
                                        <td style={{ padding: 2, border: '1px solid #ddd', textAlign: 'right' }}>
                                        ...
                                        <td style={{ padding: 2, border: '1px solid #ddd', textAlign: 'right' }}>${c._value.toFixed(2)}</td>
                                        <td style={{ padding: 2, border: '1px solid #ddd', textAlign: 'right' }}>${c._prorated.toFixed(2)}</td>
                                        <td style={{ padding: 2, border: '1px solid #ddd', textAlign: 'right' }}>${c._lineTotal.toFixed(2)}</td>
                                        <td style={{ padding: 2, border: '1px solid #ddd', textAlign: 'center' }}>
                                          <StatusChecklist
                                  ...
                                  <tfoot>
                                    <tr><td colSpan={4} style={{ padding: '3px 2px', border: '1px solid #ddd' }}>Subtotal</td><td colSpan={4} style={{ padding: '3px 2px', border: '1px solid #ddd', textAlign: 'right' }}>${subtotal.toFixed(2)}</td></tr>
                                    <tr><td colSpan={4} style={{ padding: '3px 2px', border: '1px solid #ddd' }}>Envío 1</td><td colSpan={4} style={{ padding: '3px 2px', border: '1px solid #ddd', textAlign: 'right' }}>{editing ? <input type="number" step="0.01" defaultValue={lote.envio1 || 0} onBlur={e => updateLoteExtra(lote, 'envio1', e.target.value)} style={{ width: 70, fontSize: 11 }} /> : `$${Number(lote.envio1 || 0).toFixed(2)}`}</td></tr>
                                    <tr><td colSpan={4} style={{ padding: '3px 2px', border: '1px solid #ddd' }}>Envío 2</td><td colSpan={4} style={{ padding: '3px 2px', border: '1px solid #ddd', textAlign: 'right' }}>{editing ? <input type="number" step="0.01" defaultValue={lote.envio2 || 0} onBlur={e => updateLoteExtra(lote, 'envio2', e.target.value)} style={{ width: 70, fontSize: 11 }} /> : `$${Number(lote.envio2 || 0).toFixed(2)}`}</td></tr>
                                    <tr><td colSpan={4} style={{ padding: '3px 2px', border: '1px solid #ddd' }}>Varios</td><td colSpan={4} style={{ padding: '3px 2px', border: '1px solid #ddd', textAlign: 'right' }}>{editing ? <input type="number" step="0.01" defaultValue={lote.varios || 0} onBlur={e => updateLoteExtra(lote, 'varios', e.target.value)} style={{ width: 70, fontSize: 11 }} /> : `$${Number(lote.varios || 0).toFixed(2)}`}</td></tr>
