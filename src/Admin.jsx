                          ...
                          <div className="admin-item-info" style={{ width: '100%', maxWidth: '100%', minWidth: 0, boxSizing: 'border-box' }}>
                            ...
                            <div style={{ width: '100%', maxWidth: '100%', minWidth: 0, overflowX: 'auto', WebkitOverflowScrolling: 'touch', touchAction: 'pan-x pan-y', marginTop: 2, borderRadius: 8, border: '1px solid #ddd', boxShadow: '0 1px 2px rgba(0,0,0,0.06)', boxSizing: 'border-box' }}>
                              <table style={{ borderCollapse: 'collapse', width: '100%', minWidth: 420, fontSize: 11 }}>
                                ...
                                <tfoot>
                                  <tr><td colSpan={5} style={{ padding: '3px 2px', border: '1px solid #ddd', whiteSpace: 'nowrap' }}>Subtotal</td><td colSpan={3} style={{ padding: '3px 2px', border: '1px solid #ddd', textAlign: 'right', whiteSpace: 'nowrap' }}>${subtotal.toFixed(2)}</td></tr>
                                  ...
                                  <tr style={{ background: '#f3ecdd' }}><td colSpan={5} style={{ padding: '3px 2px', border: '1px solid #ddd', whiteSpace: 'nowrap' }}><strong>Total</strong></td><td colSpan={3} style={{ padding: '3px 2px', border: '1px solid #ddd', textAlign: 'right', whiteSpace: 'nowrap' }}><strong>${totalLote.toFixed(2)}</strong></td></tr>
                                </tfoot>
                              </table>
                            </div>
                            ...
                            {addToVentaLoteId === lote.id ? (
                              ...
                              <button type="button" onClick={() => setAddToVentaLoteId(lote.id)} style={{ marginTop: 8, width: '100%', maxWidth: '100%', boxSizing: 'border-box' }}>➕ Agregar planta</button>
                            )}
                          </div>
                        </div>
                      )
