                  ...
                  <>
                    ...
                    {loteBuilderOpen && loteStep === 'header' && (
                      <div className="admin-form" style={{ display: 'flex', flexDirection: 'column', gap: 10, padding: 14 }}>
                        ...
                        <p style={{ fontSize: '0.75rem', color: '#8a8a7a', margin: '-4px 0 0' }}>La nota de la compra se agrega después, una vez guardada.</p>
                        ...
                        return (
                          <div key={lote.id} className="admin-item lote-group">
                            <div className="admin-item-info">
                              ...
                              <div style={{ overflowX: 'auto', marginTop: 8, WebkitOverflowScrolling: 'touch', borderRadius: 6, border: '1px solid #ddd' }}>
                                <table className="invoice-table" style={{ borderCollapse: 'separate', borderSpacing: 0, width: '100%', fontSize: 11.5 }}>
                                  <thead>
                                    <tr style={{ background: '#f3ecdd' }}>
                                      <th style={{ padding: '4px 3px', border: '1px solid #ddd', position: 'sticky', left: 0, width: 40, background: '#f3ecdd', zIndex: 2, boxShadow: '2px 0 3px rgba(0,0,0,0.08)' }}>Foto</th>
                                      <th style={{ padding: '4px 3px', border: '1px solid #ddd', position: 'sticky', left: 40, width: 78, background: '#f3ecdd', zIndex: 2, boxShadow: '2px 0 3px rgba(0,0,0,0.08)' }}>Nombre</th>
                                      <th style={{ padding: '4px 3px', border: '1px solid #ddd' }}>Cant.</th>
                                      <th style={{ padding: '4px 3px', border: '1px solid #ddd' }}>P.Unit</th>
                                      <th style={{ padding: '4px 3px', border: '1px solid #ddd' }}>P.Total</th>
                                      <th style={{ padding: '4px 3px', border: '1px solid #ddd' }}>Prorrateo</th>
                                      <th style={{ padding: '4px 3px', border: '1px solid #ddd' }}>Total</th>
                                      <th style={{ padding: '4px 3px', border: '1px solid #ddd' }}>Estado</th>
                                    </tr>
                                  </thead>
                                  <tbody>
                                    {lineasConProrrateo.map(c => (
                                      <tr key={c.id}>
                                        <td style={{ padding: '3px', border: '1px solid #ddd', textAlign: 'center', position: 'sticky', left: 0, width: 40, background: '#fff', zIndex: 1, boxShadow: '2px 0 3px rgba(0,0,0,0.08)' }}>
                                        ...
                                        <td style={{ padding: '3px', border: '1px solid #ddd', position: 'sticky', left: 40, width: 78, background: '#fff', zIndex: 1, boxShadow: '2px 0 3px rgba(0,0,0,0.08)' }}>
