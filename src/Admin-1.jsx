              ...
              {photoModalPlantId && (() => {
                ...
                return (
                  <div className="admin-sheet-overlay" onClick={() => { setPhotoModalPlantId(null); setPhotoModalMenuOpen(false); setPhotoModalSection(null) }}>
                    <div className="free-note-modal" onClick={e => e.stopPropagation()} style={{ position: 'relative', overflow: 'hidden' }}>
                      <div className="free-note-modal-header">
                            ...
                            <div className="admin-item-info">
                              ...
                              <div style={{ overflowX: 'auto', marginTop: 8 }}>
                                <table className="invoice-table" style={{ borderCollapse: 'collapse', width: '100%', fontSize: 13 }}>
                                  ...
                                  <tbody>
                                    {lineasConProrrateo.map(c => (
                                      <tr key={c.id}>
                                        ...
                                        <td style={{ padding: 4, border: '1px solid #ddd' }}>{c.plant_name}</td>
                                        <td style={{ padding: 4, border: '1px solid #ddd', textAlign: 'center' }}>{c.quantity}</td>
                                        <td style={{ padding: 4, border: '1px solid #ddd', textAlign: 'right' }}>${Number(c.unit_cost).toFixed(2)}</td>
                                  ...
                                  <tfoot>
                                    <tr><td colSpan={4} style={{ padding: 4, border: '1px solid #ddd' }}>Subtotal</td><td colSpan={3} style={{ padding: 4, border: '1px solid #ddd', textAlign: 'right' }}>${subtotal.toFixed(2)}</td></tr>
                                    <tr><td colSpan={4} style={{ padding: 4, border: '1px solid #ddd' }}>Envío 1</td><td colSpan={3} style={{ padding: 4, border: '1px solid #ddd', textAlign: 'right' }}><input type="number" step="0.01" defaultValue={lote.envio1 || 0} onBlur={e => updateLoteExtra(lote, 'envio1', e.target.value)} style={{ width: 80 }} /></td></tr>
                                    <tr><td colSpan={4} style={{ padding: 4, border: '1px solid #ddd' }}>Envío 2</td><td colSpan={3} style={{ padding: 4, border: '1px solid #ddd', textAlign: 'right' }}><input type="number" step="0.01" defaultValue={lote.envio2 || 0} onBlur={e => updateLoteExtra(lote, 'envio2', e.target.value)} style={{ width: 80 }} /></td></tr>
                                    <tr><td colSpan={4} style={{ padding: 4, border: '1px solid #ddd' }}>Varios</td><td colSpan={3} style={{ padding: 4, border: '1px solid #ddd', textAlign: 'right' }}><input type="number" step="0.01" defaultValue={lote.varios || 0} onBlur={e => updateLoteExtra(lote, 'varios', e.target.value)} style={{ width: 80 }} /></td></tr>
                                    <tr style={{ background: '#f3ecdd' }}><td colSpan={4} style={{ padding: 4, border: '1px solid #ddd' }}><strong>Total</strong></td><td colSpan={3} style={{ padding: 4, border: '1px solid #ddd', textAlign: 'right' }}><strong>${totalLote.toFixed(2)}</strong></td></tr>
                                  </tfoot>
                                </table>
                              </div>
